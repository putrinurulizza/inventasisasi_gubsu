...
{{-- <script src="{{ asset('libs/prismjs/plugins/toolbar/prism-toolbar.min.js') }}"></script> --}}
...
<script type="text/javascript" src="{{ asset('DataTables/moment.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('DataTables/dataTables.dateTime.min.js') }}"></script>
