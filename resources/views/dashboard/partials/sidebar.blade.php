<nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <a class="navbar-brand text-center" href="{{ route('dashboard.index') }}">
            <img class="logo-brand" src="{{ asset('images/logos/main-logo.png') }}" alt="diskominfo sumut"
                style="
          width:80%" />
        </a>
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <li class="nav-item">
                <a class="nav-link has-arrow {{ Request::is('dashboard/peminjaman') ? 'active' : '' }}"
            ...
            @if (auth()->user()->role != 3)
                <li class="nav-item">
                    <a class="nav-link has-arrow {{ Request::is('dashboard/laporan*') ? '' : 'collapsed' }}"
                        href="#!" data-bs-toggle="collapse" data-bs-target="#navLaporan" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link has-arrow {{ Request::is('dashboard/kategori') ? 'active' : '' }}"
